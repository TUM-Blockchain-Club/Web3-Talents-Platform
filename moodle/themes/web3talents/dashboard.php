...
/**
 * Logged-in Web3 Talents student dashboard (Materials + Assignment views).
 *
 * Renders the current student's REAL data from the local_web3talents plugin
 * (rounds/topics, room/team, mentor, sessions) plus Moodle core (course
 * materials via modinfo, the assignment via mod_assign). See
 * theme_web3talents_dashboard_context() in lib.php. Falls back to clear empty
 * states where no data exists yet.
 *
