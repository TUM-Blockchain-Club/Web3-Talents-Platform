...
web3t_phase8b_assert(
    $chooseurl->externalurl === (new moodle_url('/local/web3talents/choose_topic.php'))->out(false),
    'Choose Weekly Topic course link targets this Moodle site'
);
