...
web3t_phase3_assert(file_exists($CFG->dirroot . '/theme/web3talents/pix/home/hero-bg.png'), 'overview hero background image exists');
web3t_phase3_assert(file_exists($CFG->dirroot . '/theme/web3talents/pix/home/logo.png'), 'overview logo image exists');
